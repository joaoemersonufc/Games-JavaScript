...
matriz_jogo['a'][1] = Array(3);
matriz_jogo['a'][2] = Array(3);
matriz_jogo['a'][3] = Array(3);

matriz_jogo['b'][1] = Array(3);
matriz_jogo['b'][2] = Array(3);
matriz_jogo['b'][3] = Array(3);

matriz_jogo['c'][1] = Array(3);
matriz_jogo['c'][2] = Array(3);
matriz_jogo['c'][3] = Array(3);
...
$(document).ready( function(){
	...
	function ganhador(pontos){
		if(pontos == -3){
			...
			alert(jogada_1 + 'Jogador 1 venceu!!!');
			$('.jogada').off();
		}else if(pontos == 3){
